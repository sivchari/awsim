{
  "DBInstance": {
    ...
    "DBInstanceArn": "arn:aws:rds:us-east-1:000000000000:db:test-start-stop-db-instance",
    "DBInstanceAutomatedBackupsReplications": null,
    "DBInstanceClass": "db.t3.micro",
    "DBInstanceIdentifier": "test-start-stop-db-instance",
    ...
    "Endpoint": {
      "Address": "test-start-stop-db-instance.d2ce76b2.us-east-1.rds.amazonaws.com",
      "HostedZoneId": null,
      "Port": 3306
    },
    "Engine": "mysql",
    ...
    "InstanceCreateTime": "2026-03-23T07:45:26.209Z",
    "Iops": null,
